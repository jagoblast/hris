...
('COMPANY_NAME', 'PT Nusantara Digital Pratama', 'Nama resmi perusahaan untuk kop surat & slip gaji', DATETIME('now')),
('WORK_START_TIME', '08:30', 'Jam mulai masuk kerja (batas deteksi keterlambatan)', DATETIME('now')),
('WORK_END_TIME', '17:30', 'Jam selesai kerja harian standar', DATETIME('now')),
('OFFICE_LATITUDE', '-6.2088', 'Koordinat latitude kantor pusat', DATETIME('now')),
('OFFICE_LONGITUDE', '106.8456', 'Koordinat longitude kantor pusat', DATETIME('now')),
('OFFICE_RADIUS_METERS', '100', 'Radius toleransi GPS presensi dalam meter', DATETIME('now'));
